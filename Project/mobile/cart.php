            ...
            <div class="container">
                ...
                <div class="table-responsive cart_info">
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="cart_total">
                                    <p class="cart_total_price"> Total : <?php echo number_format($total) . "VND" ?></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="order.php">
                        ...
                        <div class="form-group col-md-12">
                            <input name="address" id="address" class="form-control" rows="4" placeholder="Address"></input>
                        </div>
                        <div class="form-group col-md-12">
                            <a class="btn btn-default update" href="index.php">ADD</a>
                            <a class="btn btn-default check_out" href="deletedetail.php">Delete All</a>
